...
module Suma::Postgres
  ...
  MODELS = [
    ...
    "suma/organization/membership/verification/note",
    ...
    "suma/payment/funding_transaction/off_platform_strategy",
    ...
    "suma/payment/payout_transaction/off_platform_strategy",
