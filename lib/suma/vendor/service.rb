...
#  vendor_services_search_content_trigram_index  | gist (search_content)
...
#  mobility_vendor_adapters                  | mobility_vendor_adapters_vendor_service_id_fkey           | (vendor_service_id) REFERENCES vendor_services(id)
#  program_pricings                          | program_pricings_vendor_service_id_fkey                   | (vendor_service_id) REFERENCES vendor_services(id) ON DELETE CASCADE
