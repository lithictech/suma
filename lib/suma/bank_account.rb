...
# Referenced By:
#  payment_funding_transaction_increase_ach_strategies | payment_funding_transaction_in_originating_bank_account_id_fkey | (originating_bank_account_id) REFERENCES bank_accounts(id)
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
