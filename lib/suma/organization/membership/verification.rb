...
#  organization_membership_verification_notes      | organization_membership_verification_notes_verification_id_fkey | (verification_id) REFERENCES organization_membership_verifications(id) ON DELETE CASCADE
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
