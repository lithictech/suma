...
#  legacy_verification_id | integer                  |
#  creator_id             | integer                  |
#  editor_id              | integer                  |
# Indexes:
#  organization_membership_verification_notes_pkey                 | PRIMARY KEY btree (id)
#  organization_membership_verification_notes_verification_id_inde | btree (legacy_verification_id)
...
#  organization_membership_verification_notes_verification_id_fkey | (legacy_verification_id) REFERENCES organization_membership_verifications(id) ON DELETE CASCADE
# Referenced By:
#  support_notes_members                               | support_notes_members_note_id_fkey                              | (note_id) REFERENCES support_notes(id)
#  support_notes_organization_membership_verifications | support_notes_organization_membership_verification_note_id_fkey | (note_id) REFERENCES support_notes(id)
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------
