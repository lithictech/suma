...
#  payment_book_transactions_search_content_trigram_index  | gist (search_content)
...
# Referenced By:
#  charges_contributing_book_transactions | charges_contributing_book_transactions_book_transaction_id_fkey | (book_transaction_id) REFERENCES payment_book_transactions(id)
...
#  payment_funding_transactions           | payment_funding_transactions_reversal_book_transaction_id_fkey  | (reversal_book_transaction_id) REFERENCES payment_book_transactions(id)
...
#  payment_payout_transactions            | payment_payout_transactions_reversal_book_transaction_id_fkey   | (reversal_book_transaction_id) REFERENCES payment_book_transactions(id)
