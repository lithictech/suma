...
#  payment_payout_transactions_off_platform_strategy_id_key        | UNIQUE btree (off_platform_strategy_id)
#  payment_payout_transactions_originated_book_transaction_id_key  | UNIQUE btree (originated_book_transaction_id)
#  payment_payout_transactions_reversal_book_transaction_id_key    | UNIQUE btree (reversal_book_transaction_id)
...
#  payment_payout_transactions_search_content_trigram_index        | gist (search_content)
...
#  refund_fields_valid  | (refunded_funding_transaction_id IS NULL AND crediting_book_transaction_id IS NULL OR refunded_funding_transaction_id IS NOT NULL AND crediting_book_transaction_id IS NOT NULL)
#  unambiguous_strategy | (fake_strategy_id IS NOT NULL AND stripe_charge_refund_strategy_id IS NULL AND off_platform_strategy_id IS NULL OR fake_strategy_id IS NULL AND stripe_charge_refund_strategy_id IS NOT NULL AND off_platform_strategy_id IS NULL OR fake_strategy_id IS NULL AND stripe_charge_refund_strategy_id IS NULL AND off_platform_strategy_id IS NOT NULL)
...
#  payment_payout_transactions_off_platform_strategy_id_fkey       | (off_platform_strategy_id) REFERENCES payment_off_platform_strategies(id)
...
#  payment_payout_transactions_reversal_book_transaction_id_fkey   | (reversal_book_transaction_id) REFERENCES payment_book_transactions(id)
...
# Referenced By:
#  payment_payout_transaction_audit_logs | payment_payout_transaction_audit_log_payout_transaction_id_fkey | (payout_transaction_id) REFERENCES payment_payout_transactions(id) ON DELETE CASCADE
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
