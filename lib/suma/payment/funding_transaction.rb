...
#  search_hash                    | text                     |
#  off_platform_strategy_id       | integer                  |
#  reversal_book_transaction_id   | integer                  |
# Indexes:
...
#  payment_funding_transactions_off_platform_strategy_id_key       | UNIQUE btree (off_platform_strategy_id)
#  payment_funding_transactions_originated_book_transaction_id_key | UNIQUE btree (originated_book_transaction_id)
#  payment_funding_transactions_reversal_book_transaction_id_key   | UNIQUE btree (reversal_book_transaction_id)
...
#  payment_funding_transactions_search_content_trigram_index       | gist (search_content)
...
#  originated_book_transaction_off_platform_consistency | (off_platform_strategy_id IS NULL AND originated_book_transaction_id IS NOT NULL OR off_platform_strategy_id IS NOT NULL AND originated_book_transaction_id IS NULL)
#  unambiguous_strategy                                 | (fake_strategy_id IS NOT NULL AND increase_ach_strategy_id IS NULL AND stripe_card_strategy_id IS NULL AND off_platform_strategy_id IS NULL OR fake_strategy_id IS NULL AND increase_ach_strategy_id IS NOT NULL AND stripe_card_strategy_id IS NULL AND off_platform_strategy_id IS NULL OR fake_strategy_id IS NULL AND increase_ach_strategy_id IS NULL AND stripe_card_strategy_id IS NOT NULL AND off_platform_strategy_id IS NULL OR fake_strategy_id IS NULL AND increase_ach_strategy_id IS NULL AND stripe_card_strategy_id IS NULL AND off_platform_strategy_id IS NOT NULL)
...
#  payment_funding_transactions_off_platform_strategy_id_fkey      | (off_platform_strategy_id) REFERENCES payment_off_platform_strategies(id)
...
#  payment_funding_transactions_reversal_book_transaction_id_fkey  | (reversal_book_transaction_id) REFERENCES payment_book_transactions(id)
...
#  payment_funding_transaction_audit_logs  | payment_funding_transaction_audit_l_funding_transaction_id_fkey | (funding_transaction_id) REFERENCES payment_funding_transactions(id) ON DELETE CASCADE
