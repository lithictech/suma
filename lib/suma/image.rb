...
# Check constraints:
#  unambiguous_relation | (commerce_product_id IS NOT NULL AND commerce_offering_id IS NULL OR commerce_product_id IS NULL AND commerce_offering_id IS NOT NULL)
