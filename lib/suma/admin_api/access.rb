...
class Suma::AdminAPI::Access
  ...
  MAPPING = {
    ...
    Suma::AnonProxy::VendorAccountRegistration => [:vendor_account_registration, COMMERCE, COMMERCE],
    ...
    Suma::Eligibility::MemberAssignment => [:eligibility_member_assignment, ALL, MANAGEMENT],
    ...
    Suma::Member::ResetCode => [:member_reset_code, MEMBERS, MEMBERS],
    ...
    Suma::Payment::Account => [:payment_account, PAYMENTS, PAYMENTS],
