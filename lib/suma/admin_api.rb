    ...
    def self.inherited(subclass)
      ...
      subclass.instance_eval do
        ...
        helpers do
          ...
          # Is also very useful during testing so you can see what was created in the endpoint.
          ...
          # Tell the frontend how to handle the admin action:
          # - :show (default): Show the response in the UI.
          # - :update: Update the model with the result.
          def admin_action_handler(value)
            header "Admin-Action-Handler", value.to_s
          end
