...
RSpec.describe Suma::PhoneNumber do
  ...
  describe "format_e164" do
    ...
    it "returns nil if number is not valid" do
      expect(described_class.format_e164("555444321")).to be nil
      expect(described_class.format_e164("notaphonenumber")).to be nil
      expect(described_class.format_e164("")).to be nil
