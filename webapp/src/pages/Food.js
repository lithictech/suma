      ...
      <LayoutContainer gutters top>
        {!params.get("id") ? (
          ...
          <Row>
            ...
            <h3 className="mb-4">{foodOfferings[Number(params.get("id"))].vendorName}</h3>
            {foodOfferings[Number(params.get("id"))].offeringProducts.map((f) => (
