 ...
 * @description Auto-generated from Suma::API::Entities::ProgramEnrollmentEntity
 * @property {string} name
 * @property {string} description
 * @property {Image} image
 ...
 * @property {ProgramEnrollment} programs
