...
export default function PrivacyPolicyContent({ mobile }: { mobile?: boolean }) {
  return <TODO>{mobile}</TODO>;
}
// export default function PrivacyPolicyContent({ mobile }: { mobile?: boolean }) {
...
// }
//
// const TableOfContentsNav = ({ mobile }: { mobile?: boolean }) => {
//   mobile = Boolean(mobile);
...
// };
//
// const TabLink = ({ to, label }: { to: string; label: React.ReactNode }) => {
//   return (
...
// }
//
// const PedalCol = ({ sectionKey, img, imgAlt, right, mobile }: PedalColProps) => {
