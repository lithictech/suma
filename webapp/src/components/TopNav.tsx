...
function LanguageButtons({ className }: { className?: string }) {
...
interface AuthedUserButtonsProps {
  className?: string;
  user: CurrentMember;
  onCollapse: () => void;
}

function AuthedUserButtons({ className, user, onCollapse }: AuthedUserButtonsProps) {
  return (
    <>
      <NavLinkButton
        href="/dashboard"
